...
export default class App {
  ...
  updater = new Updater('https://github.com/Emekalim/FroYoflix_v2/releases/latest/download/latest-android.yml', 'https://api.github.com/reposEmekalim/FroYoflix_v2/releases/latest')
  dialog = new Dialog()
