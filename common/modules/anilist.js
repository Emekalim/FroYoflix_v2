...
/**
 * @param {import('./al.js').Media & {lavenshtein?: number}} media
 * @param {string} name
 */
...
class AnilistClient {
  ...
  /** @returns {Promise<import('./al.js').PagedQuery<{ notifications: { id: number, type: string, createdAt: number, episode: number, media: import('./al.js').Media}[] }>>} */
  ...
  /** @returns {Promise<import('./al.js').Query<{ MediaListCollection: import('./al.js').MediaListCollection }>>} */
  ...
  async alSearchCompound(flattenedTitles) {
    ...
    /**
     * @type {import('./al.js').Query<Record<string, {media: import('./al.js').Media[]}>>}
     * @returns {Promise<[string, import('./al.js').Media][]>}
     * */
  ...
  /** @returns {Promise<import('./al.js').Query<{ AiringSchedule: { airingAt: number }}>>} */
  ...
  /** @returns {Promise<import('./al.js').PagedQuery<{ mediaList: import('./al.js').Following[]}>>} */
  following(variables) {
  ...
  /** @returns {Promise<import('./al.js').Query<{Media: import('./al.js').Media}>>} */
   ...
   * @returns {Promise<import('./al.js').Media | null>}
   */
  requestMediaID(id) {
   ...
   * @returns {Promise<import('./al.js').Media | { data: { Page: { pageInfo: { hasNextPage: boolean }, media: import('./al.js').Media[] } } }>}
   */
